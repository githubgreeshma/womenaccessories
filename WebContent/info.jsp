...
<form action="infocontroller" method="post"><div class="col-sm-6"><img src="img/redtop.jpeg" style="width:230px;height:300px" align="right" ></div>
...
<tr>
<td>
<input type="submit" value="save" ><t> </t><a href="delete.jsp" class="btn btn-primary">Delete</a><a href="update.jsp" class="btn btn-primary">Update</a>
</td>
</tr>
